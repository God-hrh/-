 ...
 */
@WebServlet("/roleOne")
public class RoleOneServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RoleOneServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//调用添加的方法
		SysRole  b=bs.querySysRoleById(sid);
	
		request.setAttribute("role", b);
		request.getRequestDispatcher("/page/role/edit.jsp").forward(request, response);
	}
