...
<main class="lyear-layout-content">
      ...
      <div class="container-fluid">
            ...
            <div class="card">
              <div class="card-header"><h4>修改区域</h4></div>
              <div class="card-body">
                
                <form action="/store/buildingUpdate" method="post" >
                  <div class="form-group">
                    <label for="example-nf-email">区域名称</label>
                     <input type="hidden"   value="${building.id }" name="id"  >
                    <input class="form-control"  value="${building.buildingName }" type="text" id="colFormLabelLg" name="buildingName" placeholder="区域名称">
                  </div>
